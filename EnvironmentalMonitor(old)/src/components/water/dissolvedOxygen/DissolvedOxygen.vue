...
<script>
    import Management from './DissolvedOxygenManagement.vue'
    import {queryIntervalTime,build} from '@/js/util/util.js'
    import query from './dissolvedOxygenQuery.js'
    import deviceWell from './DissolvedOxygenWell.vue'
