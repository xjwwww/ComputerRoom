                ...
                <div class="ctm-manage-table">
                    <!-- <div class="manage-table-operation">
                        <div class="manage-table-operation__part table-operation__part_position_left">
                            ...
                            <button type="button" class="manage-table-operation__button manage-table-operation__button_function_export" @click="openDialog('add')"  v-permission="['admin']">新增</button>
                        </div>
                    ...
                    <el-table :data="deviceSettingsToBeShown" border style="width: 100%" size="mini" height="calc(100% - 48px)">
                        ...
                        <el-table-column prop="functionCode" label="功能码" min-width="40" align="center" head-align="center"></el-table-column>                        
                        ...
                        <el-table-column label="湿度区间"  min-width="50" align="center" head-align="center">
                            <template slot-scope="scope">
                                {{scope.row.humMinimum}}~{{scope.row.humMaximum}}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column v-if="hasPermission" label="操作"  align="center" head-align="center" min-width="100">
                            <template slot-scope="scope">
        ...
        <el-dialog :title="dialogMode=='add'?'设备添加':'设备编辑'" :visible.sync="dialogVisible" width="400px" center custom-class="ctm-dialog">
            <el-form ref="deviceForm" :model="deviceForm" :rules="deviceFormRules" label-width="80px" size="small">
              ...
              <el-form-item label="湿度区间" required>
                    <el-col :span="9">
                        <el-form-item prop="humMinimum" style="margin-bottom:0;">
                            <el-input v-model="deviceForm.humMinimum" type="text"></el-input>
                        </el-form-item> 
                    </el-col>
                    <el-col class="line" :span="2" style="text-align:center;">-</el-col>
                    <el-col :span="9">
                        <el-form-item prop="humMaximum" style="margin-bottom:0;">
                            <el-input v-model="deviceForm.humMaximum" type="text"></el-input>
                        </el-form-item>
                    </el-col>
              </el-form-item>
              <el-form-item label="功能码" prop="functionCode">
                <el-select v-model="deviceForm.functionCode" placeholder="请选择" style="width:90%;" :disabled="dialogMode==='add'?false:true">
...
// import {hasPermission} from '@/js/util/permission/permission.js'
