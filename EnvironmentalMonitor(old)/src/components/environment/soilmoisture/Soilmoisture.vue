...
<script>
    import Management from './SoilmoistureManagement.vue'
    import {queryIntervalTime,build} from '@/js/util/util.js'
    import query from './soilmoistureQuery.js'
    import deviceWell from './SoilmoistureWell.vue'
