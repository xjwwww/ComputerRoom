    ...
    <div class="ctm-container ctm-container_flex_row">
            ...
            <div class="ctm-container ctm-container_flex_column">
                <div class="ctm-manage-table">
                    ...
                    <el-table :data="deviceSettingsToBeShown" border style="width: 100%" size="mini" height="calc(100% - 48px)">
                        ...
                        <el-table-column prop="gallery" label="设备通道" min-width="50" align="center" head-align="center"></el-table-column>                        
                        ...
                        <el-table-column label="范围区间" min-width="80" align="center" head-align="center">
                        ...
                        <el-table-column prop="wireLength" label="线长度" min-width="80" align="center" head-align="center"></el-table-column>
                        <el-table-column prop="intervalTime" label="间隔时间" min-width="80" align="center" head-align="center"></el-table-column>
        ...
        <el-dialog :title="dialogMode=='add'?'设备添加':'设备编辑'" :visible.sync="dialogVisible" width="400px" center custom-class="ctm-dialog">
            <el-form ref="deviceForm" :model="deviceForm" :rules="deviceFormRules" label-width="80px" size="small">
                ...
                <el-form-item label="设备通道" prop="gallery">
                    <el-select v-model="deviceForm.gallery" placeholder="请选择" style="width:90%;" :disabled="dialogMode==='add'?false:true">
                        <el-option v-for="item in 8" :key="item" :label="item" :value="item">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="所属分组" prop="groupId">
                    <el-cascader :options="this.$store.getters.groups" :props="groupsProps" placeholder="请选择分组" v-model="deviceForm.groupId" style="width:90%;">
                ...
                <el-form-item label="线长度" prop="wireLength">
                    <el-input v-model.number="deviceForm.wireLength" type="text" style="width:90%;"></el-input>
                </el-form-item>
    ...
    data(){
        return{
            deviceFormRules:{
                ...
                wireLength:[
                    { required: true, validator: floatPass}
                ]
            },
        }
    },
