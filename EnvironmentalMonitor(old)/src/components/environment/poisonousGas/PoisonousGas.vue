...
<script>
    import Management from './PoisonousGasManagement.vue'
    import {queryIntervalTime,build} from '@/js/util/util.js'
    import query from './poisonousGasQuery.js'
    import deviceWell from './PoisonousGasWell.vue'
