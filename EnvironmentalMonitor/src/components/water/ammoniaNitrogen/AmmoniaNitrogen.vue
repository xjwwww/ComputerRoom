...
<script>
    import Management from './AmmoniaNitrogenManagement.vue'
    import {queryIntervalTime,build} from '@/js/util/util.js'
    import query from './ammoniaNitrogenQuery.js'
    import deviceWell from './AmmoniaNitrogenWell.vue'
