...
<script>
    import Management from './chlorophyllManagement.vue'
    import {queryIntervalTime,build} from '@/js/util/util.js'
    import query from './chlorophyllQuery.js'
    import deviceWell from './ChlorophyllWell.vue'
