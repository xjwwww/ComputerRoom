        ...
        <div class="precision-alarm-status-well__content">
            <div class="precision-alarm-status-well__part">
                <div class="alarm-status-row">
                    <div class="alarm-status-row__key" :class="{'alarm-status-row__key_alarm':device.highTempAlarm==1}">内风机报警</div>
                ...
                <div class="alarm-status-row">
                    <div class="alarm-status-row__key"  :class="{'alarm-status-row__key_alarm':device.highHumAlarm==1}">压机低压报警</div>
            ...
            <div class="precision-alarm-status-well__part">
                <div class="alarm-status-row">
                    <div class="alarm-status-row__key"  :class="{'alarm-status-row__key_alarm':device.lowTempAlarm==1}">压机高压报警</div>
                    <div class="alarm-status-row__value" v-if="device.lowTempAlarm==0">正常</div>
                    <div class="alarm-status-row__value alarm-status-row__value_alarm" v-else>报警</div>
                </div>
                <div class="alarm-status-row">
                    <div class="alarm-status-row__key"  :class="{'alarm-status-row__key_alarm':device.lowHumAlarm==1}">烟感报警</div>
