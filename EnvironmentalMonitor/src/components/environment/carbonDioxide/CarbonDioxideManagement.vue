            ...
            <div class="ctm-container ctm-container_flex_column">
                <div class="ctm-manage-table">
                    ...
                    <el-table :data="deviceSettingsToBeShown" border style="width: 100%" size="mini" height="calc(100% - 48px)">
                        ...
                        <el-table-column prop="groupName" label="所在位置" min-width="80" align="center" head-align="center"></el-table-column>
                        <el-table-column prop="alarmValue" label="报警值" min-width="80" align="center" head-align="center"></el-table-column>
                        <el-table-column prop="ipAddress" label="IP地址"  min-width="80" align="center" head-align="center">
        ...
        <el-dialog :title="dialogMode=='add'?'设备添加':'设备编辑'" :visible.sync="dialogVisible" width="400px" center custom-class="ctm-dialog">
            <el-form ref="deviceForm" :model="deviceForm" :rules="deviceFormRules" label-width="80px" size="small">
              ...
              <el-form-item label="报警值" prop="alarmValue">
                <el-input v-model="deviceForm.alarmValue" type="text" style="width:90%;"></el-input>
              </el-form-item>
...
export default {
    ...
    // created(){
    //     this.getIps()
    //     .then(()=>this.selectedDevices=this.devices)
    // }
}
</script>
<style>
